...
class ColorConstants {
  ...
  static Color grey100 = const Color(0XFFFBFBFB);
  static Color green2 = const Color(0XFFE8F7DF);
  static Color backgroundColor = const Color(0xffF5F5F5);
  static Color selectedNavBarColor = const Color(0XFF5C0099);
  static Color unSelectedNavBar = const Color(0XFF555555);
   static Color yellow = const Color(0XFFFCEAC9);
}
