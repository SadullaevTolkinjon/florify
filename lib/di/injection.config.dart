...
import '../data/preferences/token_preferences.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i12.TokenPreference>(
        () => _i12.TokenPreference(gh<_i10.SharedPreferences>()));
    gh.factory<_i13.AuthRepository>(() => _i14.AuthRepositoryImpl(
          gh<_i4.AuthApi>(),
          gh<_i12.TokenPreference>(),
        ));
